...
extern int SolnRank(int j, bool *ignore);
...
extern int OutputScoreLines(int line1, int line2);
/* 
...
extern int scoreentries;

struct old_st_entry {
  char user[MAXUSERNAME];
  unsigned int lv, pad1, mv, pad2, ps, pad3;
};

extern struct st_entry {
  char user[MAXUSERNAME]; /* If "", this is an empty entry */
  unsigned int lv, pad1, mv, pad2, ps, pad3;
  time_t date; /* really a time_t */
