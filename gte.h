...
extern pascal Pointer GTEGetTileDataAddr(void) inline(0x24A0, tool_dispatcher);
...
extern pascal void GTERefresh(void) inline(0x26A0, tool_dispatcher);
extern pascal struct TileMapInfo GTEGetBG0TileMapInfo(void) inline(0x19A0, tool_dispatcher);
...
extern pascal struct ScreenInfo GTEGetScreenInfo(void) inline(0x1AA0, tool_dispatcher);
...
extern pascal Word GTEClearOverlay(void) inline(0x23A0, tool_dispatcher);
